//#region node_modules/.nitro/vite/services/ssr/assets/receipt-generator-D8OSXTBR.js
...
function generateReceiptHtml(b) {
	...
	const rows = b.services.map((s) => `<tr>
...
function printBookingInvoice(b) {
...
function downloadBookingInvoice(b) {
	if (typeof window === "undefined") return;
	const html = generateReceiptHtml(b);
...
//#endregion
export { printBookingInvoice as n, downloadBookingInvoice as t };
