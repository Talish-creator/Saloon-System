...
export const venues: Venue[] = [
  {
    ...
    services: [
      ...
      { category: "Coloring", name: "Full Color", duration: "1 hr, 30 min - 2 hr", price: "from AED 480" },
      ...
      { category: "Styling", name: "Blow Dry", duration: "45 min", price: "from AED 150" },
      { category: "Styling", name: "Cut & Style", duration: "1 hr", price: "from AED 320" },
  ...
  },
  {
    ...
    services: [
      { category: "Haircuts", name: "Signature Cut", duration: "1 hr", price: "from HK$ 780" },
      { category: "Haircuts", name: "Fringe Trim", duration: "15 min", price: "HK$ 120" },
      { category: "Coloring", name: "Global Colour", duration: "2 hr", price: "from HK$ 1,280" },
      { category: "Coloring", name: "Highlights", duration: "2 hr, 30 min", price: "from HK$ 1,680" },
      { category: "Styling", name: "Blowout", duration: "45 min", price: "from HK$ 380" },
    ],
    reviewsList: [
